...
>
> #### 외부수신 (외부에서 사내 교환기(IP-PBX) 전화가 수신된 경우)     
> * 수신 전화 당겨 받기 -> 수신된 전화를 네이버웍스에 등록된 사내번호 IP전화로 연결하는 기능
> * A.I. 비서로 당겨 받기 -> 수신된 전화를 STT/TTS 서비스로 연결하는 기능
> * 내 모바일로 당겨 받기 -> 수신된 전화를 네이버웍스에 등록된 모바일 번호로 연결하는 기능
> * M2C 발신 하기 -> 네이버웍스에 등록된 사내번호 IP전화로 수신전화로로 자동발신 하는 기능
> * DIPCAST WEB -> 통화내역(CDR) 확인이나, 설정 변경을 위한 교환기 웹 페이지 링크
>
...
> #### 팩스수신 (외부에서 사내 교환기(IP-PBX) 팩스가 수신된 경우)
> * 팩스 보기 -> 수신된 팩스 파일을 보여주는 기능
>
