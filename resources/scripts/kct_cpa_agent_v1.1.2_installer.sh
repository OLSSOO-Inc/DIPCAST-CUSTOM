...
echo -e "\n"
echo -e "*********************************************************"
echo -e "*   Welcome to the KCT CPA Agent v1.1.2  Installation   *"
...
wget --inet4-only https://raw.githubusercontent.com/OLSSOO-Inc/DIPCAST-CUSTOM/master/kct/cpa-agent/SCPA_1.1.2.zip
unzip SCPA_1.1.2.zip -d /usr/share/kct-cpa-agent/
mv  /usr/share/kct-cpa-agent/SCPA_1.1.2  /usr/share/kct-cpa-agent/

wget --inet4-only https://raw.githubusercontent.com/OLSSOO-Inc/DIPCAST-CUSTOM/master/kct/cpa-agent/MCPA_1.1.2.zip
unzip MCPA_1.1.2.zip -d /usr/share/kct-cpa-agent/
mv  /usr/share/kct-cpa-agent/MCPA_1.1.2  /usr/share/kct-cpa-agent/
