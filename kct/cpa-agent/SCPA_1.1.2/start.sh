...
help() {
    ...
    cat <<EOF
        ...
        help       - this screen
        start      - start SMS-MO service
        stop       - stop  SMS-MO service
        restart    - restart or start SMS-MO service
        status     - show the status of SMS-MO service
